  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-row items-center justify-center gap-5 flex-wrap">
        <div
          className="absolute top-12 right-12 z-[99] scale-[.05] origin-top-right cursor-pointer"
          onClick={() => {
            popupvalue(false);
          }}
        >
      ...
      <div className="mt-12 text-center">
        <a
          href="#"
          className="inline-block rounded bg-cyan-500 px-12 py-3 text-sm font-medium text-slate-950 transition duration-300 hover:bg-cyan-500/60 hover:text-white focus:outline-none"
        >
          Yeni Sınıf Ekle
        </a>
      </div>
