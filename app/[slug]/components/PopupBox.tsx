  ...
  return (
    <>
      <div className="flex flex-col gap-6">
        ...
        <h2 className="text-center text-4xl text-white font-bold relative -top-36">
          {" "}
          {value != "Mezun" ? `${value}.` : "Mezun"} Sınıf
        </h2>
        <div className="flex flex-row items-center justify-center gap-5 flex-wrap relative -top-24">
          {selectedClassOld?.map((item: any, idx: any) => (
            ...
            >
              <div
                className="scale-[.03] origin-top-right absolute top-2 right-2 z-[10000]"
                onClick={() => {
        ...
        <div className="mt-12 text-center relative -top-24">
          <NewClass />
        </div>
      </div>
    </>
