...
function Class() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-screen h-screen flex flex-col justify-start gap-6 items-center text-white">
        <h2 className="text-4xl font-bold">
          {className} / {value?.toUpperCase()}
        </h2>
        <div className="flex flex-row justify-start gap-x-4 gap-y-8 max-w-[70vw] flex-wrap mt-12">
              ...
              <div
                ...
                onClick={() => {
                  ...
                  const updatedStudents = [
                    ...selectedClasses.find((item: any) => item.class === value)
                      .students,
                  ];
